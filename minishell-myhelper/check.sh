...
test_all () {
    ...
    run_syntax_test 'echo a;; bcd'
    run_syntax_test 'echo a ; ; bcd'
    run_syntax_test 'echo a ; ;'
    ### Commnad not found
...
test_echo()
{
    ...
    run_test 'aaa 2>file >$afsdjofijaiojf; file file; rm file'
    run_test 'aa 2>>file; file file; rm file'
    run_test 'aa 1>>file; file file; rm file'
    run_test 'aa 0>>file; file file; rm file'
...
test_cd () {
    ...
    run_test 'mkdir test_dir ; cd test_dir ; rm -rf ../test_dir ; cd . ; pwd ; cd . ; pwd ; cd .. ; pwd'
    run_test 'mkdir test_dir ; cd test_dir ; rm -rf ../test_dir ; cd . ; pwd ; cd . ; pwd ; cd .. ; pwd'
    run_test 'mkdir test_dir ; cd test_dir ; rm -rf ../test_dir ; cd . 2>file ; file file; pwd ; cd . ; pwd ; cd .. ; pwd'
...
test_exit () {
    ...
    run_test 'exit >file 2>file 123 aaa;'
